...
Authors: Dave Fisher and Emily Dougherty.
...
def main():
    ...
    print("  Say your name")
    print("--------------------------------------------")
    ev3.Sound.speak("every double bubble blowing baby will be beaten "
                    "senseless by every able bodied patron in the bar").wait()
